...
import 'server/add_chat_members.dart' as _i18;
import 'server/chat_message.dart' as _i19;
import 'server/chats.dart' as _i20;
import 'server/create_chat.dart' as _i21;
import 'server/friend_list.dart' as _i22;
import 'server/join_chat.dart' as _i23;
import 'server/kick_chat_member.dart' as _i24;
import 'server/last_read.dart' as _i25;
import 'server/leave_chat.dart' as _i26;
import 'server/promote_chat_member.dart' as _i27;
import 'server/read_chat.dart' as _i28;
import 'server/room_members.dart' as _i29;
import 'server/self_identifier.dart' as _i30;
import 'server/update_profile.dart' as _i31;
import 'server/user.dart' as _i32;
import 'shared/rename_chat.dart' as _i33;
import 'user_persistent.dart' as _i34;
import 'protocol.dart' as _i35;
import 'package:woukiebox2_server/src/generated/chat_message.dart' as _i36;
export 'chat.dart';
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i18.AddChatMembersServer) {
      return _i18.AddChatMembersServer.fromJson(data, this) as T;
    }
    if (t == _i19.ChatMessageServer) {
      return _i19.ChatMessageServer.fromJson(data, this) as T;
    }
    if (t == _i20.ChatsServer) {
      return _i20.ChatsServer.fromJson(data, this) as T;
    }
    if (t == _i21.CreateChatServer) {
      return _i21.CreateChatServer.fromJson(data, this) as T;
    }
    if (t == _i22.FriendListServer) {
      return _i22.FriendListServer.fromJson(data, this) as T;
    }
    if (t == _i23.JoinChatServer) {
      return _i23.JoinChatServer.fromJson(data, this) as T;
    }
    if (t == _i24.KickChatMemberServer) {
      return _i24.KickChatMemberServer.fromJson(data, this) as T;
    }
    if (t == _i25.LastReadServer) {
      return _i25.LastReadServer.fromJson(data, this) as T;
    }
    if (t == _i26.LeaveChatServer) {
      return _i26.LeaveChatServer.fromJson(data, this) as T;
    }
    if (t == _i27.PromoteChatMemberServer) {
      return _i27.PromoteChatMemberServer.fromJson(data, this) as T;
    }
    if (t == _i28.ReadChatServer) {
      return _i28.ReadChatServer.fromJson(data, this) as T;
    }
    if (t == _i29.RoomMembersServer) {
      return _i29.RoomMembersServer.fromJson(data, this) as T;
    }
    if (t == _i30.SelfIdentifierServer) {
      return _i30.SelfIdentifierServer.fromJson(data, this) as T;
    }
    if (t == _i31.UpdateProfileServer) {
      return _i31.UpdateProfileServer.fromJson(data, this) as T;
    }
    if (t == _i32.UserServer) {
      return _i32.UserServer.fromJson(data, this) as T;
    }
    if (t == _i33.RenameChat) {
      return _i33.RenameChat.fromJson(data, this) as T;
    }
    if (t == _i34.UserPersistent) {
      return _i34.UserPersistent.fromJson(data, this) as T;
    }
    ...
    if (t == _i1.getType<_i18.AddChatMembersServer?>()) {
      return (data != null
          ? _i18.AddChatMembersServer.fromJson(data, this)
          : null) as T;
    }
    if (t == _i1.getType<_i19.ChatMessageServer?>()) {
      return (data != null ? _i19.ChatMessageServer.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i20.ChatsServer?>()) {
      return (data != null ? _i20.ChatsServer.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i21.CreateChatServer?>()) {
      return (data != null ? _i21.CreateChatServer.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i22.FriendListServer?>()) {
      return (data != null ? _i22.FriendListServer.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i23.JoinChatServer?>()) {
      return (data != null ? _i23.JoinChatServer.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i24.KickChatMemberServer?>()) {
      return (data != null
          ? _i24.KickChatMemberServer.fromJson(data, this)
          : null) as T;
    }
    if (t == _i1.getType<_i25.LastReadServer?>()) {
      return (data != null ? _i25.LastReadServer.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i26.LeaveChatServer?>()) {
      return (data != null ? _i26.LeaveChatServer.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i27.PromoteChatMemberServer?>()) {
      return (data != null
          ? _i27.PromoteChatMemberServer.fromJson(data, this)
          : null) as T;
    }
    if (t == _i1.getType<_i28.ReadChatServer?>()) {
      return (data != null ? _i28.ReadChatServer.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i29.RoomMembersServer?>()) {
      return (data != null ? _i29.RoomMembersServer.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i30.SelfIdentifierServer?>()) {
      return (data != null
          ? _i30.SelfIdentifierServer.fromJson(data, this)
          : null) as T;
    }
    if (t == _i1.getType<_i31.UpdateProfileServer?>()) {
      return (data != null
          ? _i31.UpdateProfileServer.fromJson(data, this)
          : null) as T;
    }
    if (t == _i1.getType<_i32.UserServer?>()) {
      return (data != null ? _i32.UserServer.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i33.RenameChat?>()) {
      return (data != null ? _i33.RenameChat.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i34.UserPersistent?>()) {
      return (data != null ? _i34.UserPersistent.fromJson(data, this) : null)
          as T;
    }
    if (t == List<int>) {
    ...
    if (t == List<_i35.Chat>) {
      return (data as List).map((e) => deserialize<_i35.Chat>(e)).toList()
          as dynamic;
    }
    ...
    if (t == List<_i35.UserServer>) {
      return (data as List).map((e) => deserialize<_i35.UserServer>(e)).toList()
          as dynamic;
    }
    if (t == _i1.getType<List<_i36.ChatMessage>?>()) {
      return (data != null
          ? (data as List).map((e) => deserialize<_i36.ChatMessage>(e)).toList()
          : null) as dynamic;
    }
    try {
  ...
  String? getClassNameForObject(Object data) {
    ...
    if (data is _i18.AddChatMembersServer) {
      return 'AddChatMembersServer';
    }
    if (data is _i19.ChatMessageServer) {
      return 'ChatMessageServer';
    }
    if (data is _i20.ChatsServer) {
      return 'ChatsServer';
    }
    if (data is _i21.CreateChatServer) {
      return 'CreateChatServer';
    }
    if (data is _i22.FriendListServer) {
      return 'FriendListServer';
    }
    if (data is _i23.JoinChatServer) {
      return 'JoinChatServer';
    }
    if (data is _i24.KickChatMemberServer) {
      return 'KickChatMemberServer';
    }
    if (data is _i25.LastReadServer) {
      return 'LastReadServer';
    }
    if (data is _i26.LeaveChatServer) {
      return 'LeaveChatServer';
    }
    if (data is _i27.PromoteChatMemberServer) {
      return 'PromoteChatMemberServer';
    }
    if (data is _i28.ReadChatServer) {
      return 'ReadChatServer';
    }
    if (data is _i29.RoomMembersServer) {
      return 'RoomMembersServer';
    }
    if (data is _i30.SelfIdentifierServer) {
      return 'SelfIdentifierServer';
    }
    if (data is _i31.UpdateProfileServer) {
      return 'UpdateProfileServer';
    }
    if (data is _i32.UserServer) {
      return 'UserServer';
    }
    if (data is _i33.RenameChat) {
      return 'RenameChat';
    }
    if (data is _i34.UserPersistent) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'AddChatMembersServer') {
      return deserialize<_i18.AddChatMembersServer>(data['data']);
    }
    if (data['className'] == 'ChatMessageServer') {
      return deserialize<_i19.ChatMessageServer>(data['data']);
    }
    if (data['className'] == 'ChatsServer') {
      return deserialize<_i20.ChatsServer>(data['data']);
    }
    if (data['className'] == 'CreateChatServer') {
      return deserialize<_i21.CreateChatServer>(data['data']);
    }
    if (data['className'] == 'FriendListServer') {
      return deserialize<_i22.FriendListServer>(data['data']);
    }
    if (data['className'] == 'JoinChatServer') {
      return deserialize<_i23.JoinChatServer>(data['data']);
    }
    if (data['className'] == 'KickChatMemberServer') {
      return deserialize<_i24.KickChatMemberServer>(data['data']);
    }
    if (data['className'] == 'LastReadServer') {
      return deserialize<_i25.LastReadServer>(data['data']);
    }
    if (data['className'] == 'LeaveChatServer') {
      return deserialize<_i26.LeaveChatServer>(data['data']);
    }
    if (data['className'] == 'PromoteChatMemberServer') {
      return deserialize<_i27.PromoteChatMemberServer>(data['data']);
    }
    if (data['className'] == 'ReadChatServer') {
      return deserialize<_i28.ReadChatServer>(data['data']);
    }
    if (data['className'] == 'RoomMembersServer') {
      return deserialize<_i29.RoomMembersServer>(data['data']);
    }
    if (data['className'] == 'SelfIdentifierServer') {
      return deserialize<_i30.SelfIdentifierServer>(data['data']);
    }
    if (data['className'] == 'UpdateProfileServer') {
      return deserialize<_i31.UpdateProfileServer>(data['data']);
    }
    if (data['className'] == 'UserServer') {
      return deserialize<_i32.UserServer>(data['data']);
    }
    if (data['className'] == 'RenameChat') {
      return deserialize<_i33.RenameChat>(data['data']);
    }
    if (data['className'] == 'UserPersistent') {
      return deserialize<_i34.UserPersistent>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      ...
      case _i34.UserPersistent:
        return _i34.UserPersistent.t;
    }
    return null;
  }
