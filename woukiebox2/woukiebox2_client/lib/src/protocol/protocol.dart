...
import 'room_members.dart' as _i4;
import 'system_message.dart' as _i5;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i4.RoomMembers) {
      return _i4.RoomMembers.fromJson(data, this) as T;
    }
    if (t == _i5.SystemMessage) {
      return _i5.SystemMessage.fromJson(data, this) as T;
    }
    if (t == _i6.User) {
    ...
    if (t == _i1.getType<_i4.RoomMembers?>()) {
      return (data != null ? _i4.RoomMembers.fromJson(data, this) : null) as T;
    }
    if (t == _i1.getType<_i5.SystemMessage?>()) {
      return (data != null ? _i5.SystemMessage.fromJson(data, this) : null)
          as T;
    }
  ...
  String? getClassNameForObject(Object data) {
    ...
    if (data is _i4.RoomMembers) {
      return 'RoomMembers';
    }
    if (data is _i5.SystemMessage) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'RoomMembers') {
      return deserialize<_i4.RoomMembers>(data['data']);
    }
    if (data['className'] == 'SystemMessage') {
      return deserialize<_i5.SystemMessage>(data['data']);
    }
