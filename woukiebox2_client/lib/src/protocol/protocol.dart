...
import 'server/friend_list.dart' as _i12;
import 'server/join_chat.dart' as _i13;
import 'server/leave_chat.dart' as _i14;
import 'server/room_members.dart' as _i15;
import 'server/self_identifier.dart' as _i16;
import 'server/update_profile.dart' as _i17;
import 'server/user.dart' as _i18;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i12.FriendListServer) {
      return _i12.FriendListServer.fromJson(data, this) as T;
    }
    if (t == _i13.JoinChatServer) {
      return _i13.JoinChatServer.fromJson(data, this) as T;
    }
    if (t == _i14.LeaveChatServer) {
      return _i14.LeaveChatServer.fromJson(data, this) as T;
    }
    ...
    if (t == _i1.getType<_i12.FriendListServer?>()) {
      return (data != null ? _i12.FriendListServer.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i13.JoinChatServer?>()) {
      return (data != null ? _i13.JoinChatServer.fromJson(data, this) : null)
          as T;
    }
    if (t == _i1.getType<_i14.LeaveChatServer?>()) {
      return (data != null ? _i14.LeaveChatServer.fromJson(data, this) : null)
          as T;
    }
  ...
  String? getClassNameForObject(Object data) {
    ...
    if (data is _i12.FriendListServer) {
      return 'FriendListServer';
    }
    if (data is _i13.JoinChatServer) {
      return 'JoinChatServer';
    }
    if (data is _i14.LeaveChatServer) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'FriendListServer') {
      return deserialize<_i12.FriendListServer>(data['data']);
    }
    if (data['className'] == 'JoinChatServer') {
      return deserialize<_i13.JoinChatServer>(data['data']);
    }
    if (data['className'] == 'LeaveChatServer') {
      return deserialize<_i14.LeaveChatServer>(data['data']);
    }
